...
export { default as Up } from "./arrowhead-up.png";
export { default as Caramel } from "./Caramel-min.png";
export { default as Chocolate } from "./Chocolate-min.png";
export { default as Coconut } from "./Coconut-min.png";
export { default as Cookie } from "./Cookie-min.png";
